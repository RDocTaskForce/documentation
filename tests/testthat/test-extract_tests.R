...
context('tests extracted from file `C:/Users/aredd/Box Sync/Projects/rdtf/documentation/R/extract_tests.R`')
#line 251 "C:/Users/aredd/Box Sync/Projects/rdtf/documentation/R/extract_tests.R"
test_that('#', {#@TESTING
    tmp.dir <- tempdir()
